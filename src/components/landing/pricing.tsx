  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <motion.div className="mx-auto max-w-2xl sm:text-center" variants={itemVariants}>
        ...
        <motion.div 
          className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-stretch gap-8 sm:mt-20 lg:max-w-4xl lg:grid-cols-2"
          variants={containerVariants}
        >
          ...
          <motion.div variants={itemVariants}>
            <Card className="relative border-2 border-black dark:border-white flex flex-col transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 dark:bg-neutral-900 h-full">
