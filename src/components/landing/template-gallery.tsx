  ...
  return (
    <section id="templates" className="relative py-24 sm:py-32 lg:py-48 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[40%] left-[10%] w-[500px] h-[500px] rounded-full bg-slate-500/8 blur-[150px]" />
        <div className="absolute bottom-[20%] right-[20%] w-[600px] h-[600px] rounded-full bg-slate-400/10 blur-[150px]" />
      </div>
