  ...
  return (
    <footer className="relative pt-32 pb-16 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[20%] left-[30%] w-[600px] h-[600px] rounded-full bg-slate-400/10 blur-[150px]" />
        <div className="absolute bottom-[30%] right-[20%] w-[500px] h-[500px] rounded-full bg-slate-500/8 blur-[120px]" />
      </div>
